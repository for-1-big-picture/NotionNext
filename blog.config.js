...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '非常兔子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '𝐸𝓉𝑒𝓇𝓃𝒶𝓁 𝒻𝒶𝓈𝒸𝒾𝓃𝒶𝓉𝒾𝑜𝓃', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lets-shake-it.life/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'letmemakeasplash@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'public/3YZYQ3O{TLV4E1@Y]L4VH`O.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'wechat,qq,weibo,email,facebook,twitter,telegram,messenger,whatsapp', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8744323619', // 对应歌单的 id
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'public/favicon.ico', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '非常兔子的BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'always interesting', // 站点描述，被notion中的页面描述覆盖
